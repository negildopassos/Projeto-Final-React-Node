...
exports.createCliente = (req, res) => {
    ...
    try {
        ...
        Cliente.create(cliente, { attributes: ['id', 'nome', 'email', 'idade','telefone'] })
            .then(result => {
...
exports.getCliente = (req, res) => {
    ...
    Cliente.findByPk(req.params.id, { attributes: ['id', 'nome', 'email', 'idade', 'telefone'] })
        .then(cliente => {
...
exports.clientes = (req, res) => {
    ...
    try {
        Cliente.findAll({ attributes: ['id', 'nome', 'email', 'idade', 'telefone'] })
            .then(clientes => {
    ...
    try {
        ...
        if (!cliente) {
            ...
            let result = await Cliente.update(updatedObject, {
                ...
                attributes: ['id', 'nome', 'email', 'idade', 'telefone']
            });
